(function () {
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      @media(min-width:620px){html.pmg-tablet.pmg-notifications-mounted .pmg-theme-control{right:76px!important}html.pmg-tablet.pmg-notifications-mounted .pmg-theme-panel{right:76px!important}html.pmg-tablet #pmg-notice-bell{right:18px!important;top:calc(112px + env(safe-area-inset-top))!important}#pmg-notice-panel{align-items:center;padding:24px}#pmg-notice-panel .pmg-notice-box{border-radius:26px;box-shadow:0 24px 90px var(--pmg-shadow,#0008)}}
