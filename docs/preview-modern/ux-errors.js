(function(){
  ...
  const MAP={
    ...
    invalid_import_file:'No hemos podido leer ese archivo. Comprueba que sea un Excel .xlsx, CSV o TSV válido.',
    invalid_import_file_size:'El archivo supera el límite de 6 MB. Divide el Excel o selecciona un archivo más pequeño.',
    unsupported_import_format:'Este formato no es compatible. Guarda el archivo como .xlsx, .csv o .tsv y vuelve a intentarlo.',
    empty_import_file:'El archivo no contiene filas de reservas que se puedan analizar.',
    ai_import_not_configured:'La importación con IA todavía no está configurada. Puedes crear las entradas manualmente mientras tanto.',
    ai_import_failed:'La IA no ha podido analizar el archivo en este momento. Vuelve a intentarlo dentro de unos minutos.',
    ai_import_invalid_response:'La IA no devolvió una lectura válida del archivo. Revisa los encabezados e inténtalo de nuevo.',
    ai_import_headers_not_found:'La IA no ha podido identificar los encabezados del Excel. Comprueba que estén visibles en una sola fila.',
    invalid_server_response:'El sistema devolvió una respuesta incompleta. Actualiza la pantalla y vuelve a intentarlo.',
    write_permission_required:'Tu permiso actual es solo Lectura. Solicita Lectura/Escritura al administrador que lo tiene activo.',
    write_permission_changed:'El permiso de Lectura/Escritura cambió desde que abriste esta pantalla. Los datos no se han modificado; actualiza y vuelve a intentarlo.',
    already_write_holder:'Ya tienes activo el permiso de Lectura/Escritura.',
    write_holder_unavailable:'No hay un titular disponible para responder. Contacta con Root para recuperar el permiso.',
    booking_not_found:'Esta entrada ya no está disponible. Actualiza la lista antes de continuar.',
    booking_conflict:'Otra actualización cambió esta entrada. Tus cambios no se han aplicado; revisa la versión actual y vuelve a intentarlo.',
    invalid_booking_entry:'Faltan datos obligatorios o alguno no tiene un formato válido. Revisa el formulario.',
    invalid_booking_dates:'La fecha de regreso no puede ser anterior a la fecha de recogida.',
    invalid_booking_price:'El precio debe ser igual o superior a cero.',
    invalid_booking_email:'El e-mail no tiene un formato válido.',
    booking_value_too_long:'Uno de los textos es demasiado largo. Acórtalo y vuelve a intentarlo.',
    invalid_bulk_selection:'La selección para eliminar no es válida. Actualiza la lista y vuelve a seleccionarla.',
    duplicate_bulk_selection:'Una entrada aparece seleccionada más de una vez. Actualiza la lista y vuelve a intentarlo.',
    import_analysis_not_found:'No encontramos el análisis del Excel. Selecciona el archivo y vuelve a analizarlo.',
    import_analysis_expired:'La revisión del Excel ha caducado. Analiza el archivo de nuevo antes de importarlo.',
    invalid_import_selection:'La selección de filas del Excel no es válida. Revisa la previsualización.',
    empty_import_selection:'Selecciona al menos una fila válida para importar.',
    permission_request_not_found:'Esta solicitud ya no está disponible. Actualiza las notificaciones.',
    permission_request_not_recipient:'Esta solicitud debe responderla el administrador al que fue enviada.',
    permission_request_resolved:'Esta solicitud ya fue atendida. Actualiza la pantalla para ver el permiso actual.',
    permission_request_stale:'La solicitud ha caducado porque el permiso cambió mientras estaba pendiente.',
    invalid_permission_decision:'No se ha podido interpretar la respuesta a la solicitud. Actualiza y vuelve a intentarlo.',
    invalid_transfer_target:'Solo puedes transferir Lectura/Escritura a otro Root o Admin activo.',
    invalid_idempotency_key:'No se pudo asegurar la operación frente a reintentos. Actualiza la pantalla y vuelve a intentarlo.',
    idempotency_key_reused:'La operación ya fue utilizada para otro cambio. Actualiza la pantalla y vuelve a intentarlo.',
