...
const routes={
  ...
  "vehicles.html":{back:"operations.html",backLabel:"Operaciones",home:"./"},
  "recent.html":{back:"operations.html",backLabel:"Operaciones",home:"./"},
  "vehicle-v7.html":{back:"operations.html",backLabel:"Operaciones",home:"./"},
  "optimizer-settings.html":{back:"./",backLabel:"Inicio",home:"./"},
  "system-info.html":{back:"./",backLabel:"Inicio",home:"./"},
  "team-live.html":{back:"operations.html",backLabel:"Operaciones",home:"./"},
  "gps-diagnostic.html":{back:"operations.html",backLabel:"Operaciones",home:"./"},
  "legal.html":{back:"./",backLabel:"Inicio",home:"./"},
  "park.html":{bar:false},
  "pickup.html":{bar:false},
  "relocate.html":{bar:false},
  "delivery.html":{bar:false},
  "search.html":{bar:false}
};

let customBack=null,armed=false,handling=false;
const MARK="__pmg_android_back__";

function sameDocument(href){try{const a=new URL(href,location.href),b=new URL(location.href);return a.origin===b.origin&&a.pathname===b.pathname&&a.search===b.search&&a.hash===b.hash}catch{return false}}
function arm(){
  if(armed)return;
  try{history.pushState({...history.state,[MARK]:true},"",location.href);armed=true}catch{}
}
function rearmIfStillHere(before){
  setTimeout(()=>{if(sameDocument(before)){armed=false;arm()}},0);
}
function defaultBack(){
  ...
  if(cfg?.back){location.href=cfg.back;return}
  location.href="./";
}
function runBack(){
  if(handling)return;
...
window.PMGNavigation={
  setBackHandler(fn){customBack=typeof fn==="function"?fn:null;arm()},
  clearBackHandler(){customBack=null;arm()},
  back(){runBack()},
  arm
};
arm();
