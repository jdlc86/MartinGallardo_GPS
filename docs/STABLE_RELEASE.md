...
La URL declarada por `telegram-gateway` y `telegram-modern-action` corresponde a `20260908B01`.
...
## Baseline consolidada 2026.09.08.01

Las correcciones posteriores a la baseline del 4 de septiembre quedan consolidadas formalmente en **1.4.0 / Build 2026.09.08.01**.
