...
La URL declarada por `telegram-gateway` y `telegram-modern-action` corresponde a `20260906B10`.
...
## Baseline consolidada 2026.09.06.10

Las correcciones posteriores a la baseline del 4 de septiembre quedan consolidadas formalmente en **1.4.0 / Build 2026.09.06.10**.
