-- Exclude long-lived replication/walsender sessions from the long-query health metric.
-- Realtime replication is expected to remain active for many hours and is not a stuck SQL query.
